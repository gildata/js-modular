...
NSB_TS_FV.Modules.newlyAddedListing = NSB_TS_FV.Modules.newlyAddedListing || ((url = ``, debug = false, uid = `default_dom_uid`, ui_arr = ["gpjs", "zqdm", "zqjc", "sshy", "zbqs", "mgsy", "mgjzc", "jlrtbzz", "jzcsyl", "zgb", "ltgb"]) => {
    ...
    .then(
        (json) => {
            ...
            // array
            NSB_TS_FV.Modules.newlyAddedListingHC(datas, uid, json, false);
        }
    )
...
NSB_TS_FV.Modules.newlyAddedListingHC = NSB_TS_FV.Modules.newlyAddedListingHC || ((datas = [], container_uid = `container`, json = {}, debug = false) => {
...
NSB_TS_FV.Modules.newlyAddedListing.showTable = NSB_TS_FV.Modules.newlyAddedListing.showTable || ((code = `600570`, table_dom_uid = `table_dom_uid`, data = {}, debug = false) => {
    // draw table
    if (debug) {
